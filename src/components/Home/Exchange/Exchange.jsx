        ...
        <div className="container mt-16 mx-auto">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center justify-end gap-3 text-nowrap">
                    {/* View All button */}
                    <button className="button-color px-4 py-2 rounded-full text-base text-orange-50 flex items-center gap-1">
                        View All
                    </button>
                    {/* Previous Button */}
                    <button className="button-color p-2 rounded-full text-orange-50 flex items-center gap-1" onClick={handlePrevButtonClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12 15.75 4.5" />
                        </svg>
                    </button>
                    {/* Next Button */}
                    <button className="button-color p-2 rounded-full text-orange-50 flex items-center gap-1" onClick={handleNextButtonClick}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
